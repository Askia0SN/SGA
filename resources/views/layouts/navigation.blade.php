<nav x-data="{ open: false }" class="relative z-50 border-b border-[#e8e2f5] bg-white">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('candidatures.index')" :active="request()->routeIs('candidatures.index', 'candidatures.show')">
                        Candidatures
                    </x-nav-link>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center rounded-md p-2 text-[#6d6684] transition duration-150 ease-in-out hover:bg-[#f7f5fb] hover:text-[#27185f] focus:outline-none">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('candidatures.index')" :active="request()->routeIs('candidatures.index', 'candidatures.show')">
                Candidatures
            </x-responsive-nav-link>
            @if (Auth::user()->hasRole('super_admin'))
        ...
        <div class="border-t border-[#e8e2f5] pb-1 pt-4">
            <div class="px-4">
                <div class="text-base font-bold text-[#27185f]">{{ Auth::user()->name }}</div>
                <div class="text-sm font-medium text-[#6d6684]">{{ Auth::user()->email }}</div>
            </div>
